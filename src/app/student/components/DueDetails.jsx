...
// Mock formatDate function - replace with your actual implementation
...
const DueDetails = ({ data }) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-gray-500 text-center max-w-md">
          Great news! You don't have any pending dues at the moment.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Quick Actions */}
      {pendingDues > 0 && (
        <Card className="border-0 shadow-lg button-grad text-white">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold mb-1">Quick Payment</h3>
                <p className="text-blue-100">Pay all pending dues at once</p>
              </div>
              <Button
                className="bg-white text-blue-600 hover:bg-gray-100 font-medium px-6"
                onClick={() =>
                  router.push(`/student/paydue/pay-all?roll=${data.roll}`)
                }
              >
