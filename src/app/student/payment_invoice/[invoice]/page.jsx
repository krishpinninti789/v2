...
const PaymentInvoicePage = () => {
  ...
  useEffect(() => {
    ...
    if (payid) fetchInvoiceData();
  }, [payid]);

  const handleDownloadPDF = async () => {
    if (!invoiceRef.current || !invoice_data) return;
    ...
    try {
      ...
      pdf.save(`${invoice_data.roll}_invoice_${invoice_data.paymentId}.pdf`);
    } catch (error) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Invoice #{invoice_data.paymentId.slice(-8).toUpperCase()}
              </p>
            </div>
          </div>
        ...
        >
          ...
          <Card className="shadow-xl border-0 overflow-hidden">
            <div ref={invoiceRef} className="bg-white">
              {/* Invoice Header */}
              <div className="button-grad text-white p-8">
                  ...
                  <div className="text-right">
                    ...
                    <div className="space-y-1 text-blue-100">
                      <p className="flex items-center gap-2 justify-end">
                        ...
                        {formatDate(invoice_data.createdAt)}
                      </p>
                      <p className="flex items-center gap-2 justify-end">
                        <Clock className="w-4 h-4" />
                        {formatTime(invoice_data.createdAt)}
                      </p>
                    </div>
                  </div>
                </div>
